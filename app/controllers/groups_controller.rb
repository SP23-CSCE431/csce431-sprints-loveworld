class GroupsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @group.save
        format.html { redirect_to(group_url(@group), info: 'Group was successfully created.') }
  ...
  def update
    respond_to do |format|
      if @group.update(group_params)
        format.html { redirect_to(group_url(@group), info: 'Group was successfully updated.') }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to(groups_url, info: 'Group was successfully destroyed.') }
